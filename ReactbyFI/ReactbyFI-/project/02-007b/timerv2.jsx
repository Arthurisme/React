...
return {time: null, int:null}
    ...
    render: function (){
        ...
        return  (
            <div>
                <h2>Timer</h2>
                <Button time="5"  remaintime = {this.state.time} startTimer={this.startTimer}/>
...
var Button =React.createClass({
    ...
    render: function (){
        ...
        return  <button onClick={this.startTimer}> {this.props.remaintime}  of {this.props.time} seconds </button>
